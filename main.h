...
* @space_flag: om if hashtag_flag specified
...
*
* @h_modifier: on if h_modifier specified (short)
* @l_modifier: on if l_modifier is specified (long)
*
*/
...
int_rot13(va_list ap, params_t *params);
